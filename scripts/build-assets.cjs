...
const source=new Set(['styles.css','fcc-ui.css','fcc-core.js','fcc-store.js','fcc-ui.js','fcc-clinical-ui.js','app.js','navigation-hub.js','wound-images-curated-v1.json']);
...
const prefix=files=>files.map(p=>dir+'/'+p),core=[...prefix(['styles.css','fcc-ui.css','fcc-core.js','fcc-store.js','fcc-ui.js','fcc-clinical-ui.js','app.js','navigation-hub.js',...moduleFiles('shell'),...moduleFiles('home')]),'index.html','manifest.webmanifest','icon-192.png','icon-512.png','icon.svg'];
