...
5. Se o Android Studio pedir componentes de SDK, aceitar a instalação da API 37/Build Tools necessários.
...
- Não foi executado um build Android/APK dentro do ambiente de criação porque este ambiente não dispõe do Android SDK completo.
