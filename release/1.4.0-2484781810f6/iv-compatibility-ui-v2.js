(()=>{
  ...
  add('Isoprenalina','Cloreto de potássio','Classificação pendente: a concentração, o diluente e as condições do estudo primário não estão integralmente confirmados. Não utilizar o resultado como autorização para coadministração.');
  ...
  function css(){
    ...
    const st=document.createElement('style');st.id='ivc-combo-v2-style';st.textContent=`
      ...
      .ivc-suggestion{display:flex;width:100%;gap:8px;align-items:center;text-align:left;border:0;background:transparent;color:var(--text);border-radius:10px;padding:9px 10px;cursor:pointer}.ivc-suggestion:hover,.ivc-suggestion.active{background:rgba(92,202,255,.09)}.ivc-suggestion strong{font-size:var(--fcc-caption,.8125rem)}.ivc-suggestion span{display:block;margin-top:2px;color:var(--muted);font-size:var(--fcc-caption,.8125rem)}.ivc-suggest-empty{padding:10px;color:var(--muted);font-size:var(--fcc-caption,.8125rem)}
      .ivc-evidence-lite{border:1px solid rgba(244,187,85,.28);border-radius:18px;padding:16px;background:rgba(244,187,85,.055)}.ivc-evidence-lite .signal{display:flex;gap:11px;align-items:center}.ivc-evidence-lite .ico{width:48px;height:48px;border-radius:14px;display:grid;place-items:center;background:rgba(244,187,85,.12);border:1px solid rgba(244,187,85,.35);font-size:22px;color:#f3c878;font-weight:900}.ivc-evidence-lite h3{margin:0;font-size:17px}.ivc-evidence-lite p{font-size:var(--fcc-caption,.8125rem);line-height:1.55;color:var(--muted);margin:8px 0 0}.ivc-evidence-lite .limits{margin-top:10px;padding:10px;border-radius:11px;background:rgba(244,187,85,.07);border:1px solid rgba(244,187,85,.18);font-size:var(--fcc-caption,.8125rem);color:#ebd29d}.ivc-v2-sources{display:flex;gap:6px;flex-wrap:wrap;margin-top:10px}.ivc-v2-sources a{font-size:var(--fcc-caption,.8125rem);text-decoration:none;border:1px solid rgba(113,158,190,.2);border-radius:9px;padding:6px 8px;background:rgba(8,22,34,.7)}
