(()=>{
  ...
  function style(){
    ...
    const s=document.createElement('style');s.id='ecga-v3-style';s.textContent=`
      #ecgAnalyzerV2{display:none!important}.ecg3{grid-column:1/-1;border:1px solid rgba(98,212,255,.25);background:var(--panel);border-radius:18px;padding:15px}.ecg3-head{display:flex;gap:12px;align-items:flex-start}.ecg3-head h3{margin:0;font-size:19px}.ecg3-head p{margin:4px 0 0;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.5}.ecg3-head .spacer{flex:1}.ecg3-controls{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-top:11px}.ecg3-confirm{grid-column:1/-1;display:flex;gap:8px;align-items:flex-start;border:1px solid var(--line);border-radius:12px;padding:9px 10px;background:var(--panel-2);font-size:var(--fcc-caption,.8125rem);line-height:1.45}.ecg3-confirm input{width:auto;margin-top:2px}.ecg3-crop{grid-column:1/-1;border:1px solid var(--line);border-radius:12px;padding:9px;background:var(--panel-2)}.ecg3-crop summary{font-size:var(--fcc-caption,.8125rem);font-weight:800;cursor:pointer}.ecg3-crop-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:7px;margin-top:8px}.ecg3-actions{display:flex;gap:7px;flex-wrap:wrap;margin-top:9px}.ecg3-status{margin-top:8px;font-size:var(--fcc-caption,.8125rem);color:var(--muted)}.ecg3-progress{display:none;height:5px;border-radius:999px;background:var(--panel-2);overflow:hidden;margin-top:7px}.ecg3-progress span{display:block;height:100%;width:0;background:var(--clinical)}.ecg3-gate{margin-top:10px;border:1px solid var(--line);border-radius:13px;padding:10px;background:var(--panel-2)}.ecg3-gate.good{border-color:rgba(114,227,167,.35)}.ecg3-gate.warn{border-color:rgba(242,185,94,.42)}.ecg3-gate.bad{border-color:rgba(255,123,134,.42)}.ecg3-gate b{font-size:var(--fcc-caption,.8125rem)}.ecg3-gate p{font-size:var(--fcc-caption,.8125rem);line-height:1.5;color:var(--muted);margin:4px 0 0}.ecg3-kpis{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px;margin-top:10px}.ecg3-kpi{border:1px solid var(--line);border-radius:13px;background:var(--panel-2);padding:10px}.ecg3-kpi small{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);letter-spacing:.08em;text-transform:uppercase}.ecg3-kpi strong{display:block;font-size:17px;margin-top:4px}.ecg3-kpi span{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);margin-top:3px}.ecg3-find{display:grid;gap:7px;margin-top:10px}.ecg3-find>div{border:1px solid var(--line);border-radius:12px;background:var(--panel-2);padding:9px 10px;font-size:var(--fcc-caption,.8125rem);line-height:1.5}.ecg3-find .warn{border-color:rgba(242,185,94,.36)}.ecg3-find .bad{border-color:rgba(255,123,134,.36)}.ecg3-find .good{border-color:rgba(114,227,167,.3)}.ecg3-leads{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:6px;margin-top:9px}.ecg3-lead{border:1px solid var(--line);border-radius:10px;padding:7px;background:var(--panel-2)}.ecg3-lead b{font-size:var(--fcc-caption,.8125rem)}.ecg3-lead span{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);margin-top:2px}.ecg3-wave{margin-top:9px;border:1px solid var(--line);border-radius:13px;background:var(--panel-2);padding:8px;overflow:auto}.ecg3-wave canvas{display:block;width:100%;min-width:620px;height:185px}.ecg3-note{margin-top:9px;border:1px solid rgba(242,185,94,.3);background:rgba(242,185,94,.055);border-radius:12px;padding:10px;font-size:var(--fcc-caption,.8125rem);line-height:1.55}
