(()=>{
  ...
  CATEGORIES['Regras documentais existentes']=['Verapamil','Vecurónio'];
  ...
  function addStyles(){
    ...
    const st=document.createElement('style');st.id='ivcat-style';st.textContent=`
      .ivcat-bar{display:flex;gap:7px;align-items:center;flex-wrap:wrap;margin:0 0 10px}.ivcat-stat{font-size:var(--fcc-caption,.8125rem);padding:6px 8px;border-radius:999px;border:1px solid rgba(92,202,255,.18);background:rgba(92,202,255,.05);color:#b7e8fa}
      .ivcat-filter{display:flex;gap:8px;align-items:end;flex-wrap:wrap;margin:0 0 10px}.ivcat-filter label{min-width:240px;flex:1}.ivcat-filter small{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);margin-bottom:5px}
      .ivcat-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:10px}.ivcat-card{border:1px solid rgba(113,158,190,.16);border-radius:14px;padding:10px;background:rgba(8,22,34,.6)}.ivcat-card h4{margin:0;font-size:var(--fcc-caption,.8125rem)}.ivcat-card h4 span{color:#8ddfff;font-size:var(--fcc-caption,.8125rem)}.ivcat-card p{margin:6px 0 0;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.5}
      .ivcat-special{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:10px}.ivcat-special>div{border:1px solid rgba(244,187,85,.18);background:rgba(244,187,85,.045);border-radius:13px;padding:10px}.ivcat-special b{font-size:var(--fcc-caption,.8125rem);color:#efd497}.ivcat-special span{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.45;margin-top:3px}
      .ivcat-sources{display:flex;gap:7px;flex-wrap:wrap;margin-top:10px}.ivcat-sources a{font-size:var(--fcc-caption,.8125rem);text-decoration:none;border:1px solid rgba(113,158,190,.18);border-radius:10px;padding:7px 8px;background:rgba(8,22,34,.55)}
