(()=>{
  ...
  add('Dexmedetomidina','Furosemida','conditional','Condições e apresentação por confirmar','A classificação automática como compatível foi retirada: é necessária confirmação da formulação, diluente e condições da fonte específica.','Não extrapolar automaticamente para concentrações diferentes.', ['vch','stabilis','greenhill']);
  ...
  function ensureStyles(){
    ...
    const st=document.createElement('style');st.id='ivc-style';st.textContent=`
      .ivc-shell{display:grid;gap:12px;margin-top:10px}.ivc-pick{display:grid;grid-template-columns:1fr 56px 1fr;gap:10px;align-items:end}.ivc-swap{height:42px;border-radius:13px}.ivc-result{border:1px solid var(--line);border-radius:20px;background:linear-gradient(145deg,rgba(10,25,39,.95),rgba(6,16,26,.95));padding:17px}.ivc-result-head{display:flex;gap:13px;align-items:center}.ivc-signal{width:58px;height:58px;border-radius:17px;display:grid;place-items:center;font-size:28px;font-weight:950;flex:0 0 auto}.ivc-ok .ivc-signal{background:rgba(59,209,155,.13);border:1px solid rgba(59,209,155,.42);color:#75e1bc}.ivc-bad .ivc-signal{background:rgba(255,110,121,.13);border:1px solid rgba(255,110,121,.42);color:#ff929b}.ivc-warn .ivc-signal{background:rgba(244,187,85,.12);border:1px solid rgba(244,187,85,.4);color:#f4c975}.ivc-result h3{margin:0;font-size:20px}.ivc-status{font-size:var(--fcc-caption,.8125rem);font-weight:950;letter-spacing:.13em;margin-bottom:4px}.ivc-result p{margin:10px 0 0;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.55}.ivc-action{margin-top:12px;border-radius:13px;padding:10px 12px;font-size:var(--fcc-caption,.8125rem);font-weight:800}.ivc-ok .ivc-action{background:rgba(59,209,155,.07);border:1px solid rgba(59,209,155,.2);color:#bcebd9}.ivc-bad .ivc-action{background:rgba(255,110,121,.07);border:1px solid rgba(255,110,121,.2);color:#ffc2c6}.ivc-warn .ivc-action{background:rgba(244,187,85,.07);border:1px solid rgba(244,187,85,.2);color:#efd497}.ivc-evidence{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:12px}.ivc-source{display:block;text-decoration:none;border:1px solid rgba(113,158,190,.18);border-radius:13px;padding:10px;background:rgba(8,22,34,.7)}.ivc-source:hover{border-color:rgba(92,202,255,.45)}.ivc-source b{font-size:var(--fcc-caption,.8125rem);display:block}.ivc-source span{display:block;font-size:var(--fcc-caption,.8125rem);color:var(--muted);line-height:1.4;margin-top:3px}.ivc-confidence{display:flex;gap:7px;align-items:center;flex-wrap:wrap;margin-top:12px}.ivc-dot{width:8px;height:8px;border-radius:50%;background:#3bd19b;box-shadow:0 0 12px rgba(59,209,155,.5)}.ivc-empty{border:1px dashed rgba(244,187,85,.28);border-radius:18px;padding:18px;text-align:center;background:rgba(244,187,85,.04)}.ivc-empty strong{display:block;font-size:16px}.ivc-empty p{margin:6px auto 0;max-width:650px;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.55}.ivc-policy{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.ivc-policy>div{border:1px solid rgba(113,158,190,.16);border-radius:14px;padding:11px;background:rgba(8,22,34,.6)}.ivc-policy b{font-size:var(--fcc-caption,.8125rem)}.ivc-policy span{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.45;margin-top:3px}.ivc-legend{display:flex;gap:8px;flex-wrap:wrap}.ivc-chip{font-size:var(--fcc-caption,.8125rem);padding:6px 8px;border-radius:999px;border:1px solid var(--line)}
  ...
  function ensureModule(){
    ...
    const sub=document.createElement('div');sub.className='sub';sub.id='clin-ivcompat';sub.innerHTML=`
      <div class="ivc-shell">
        <div class="pagehead" style="margin-top:0"><div><h2 style="font-size:22px">Compatibilidade IV</h2><p>Consulta de resultados documentais de compatibilidade física em Y-site, com condições e referências.</p></div><span class="badge warn">Y-site ≠ mistura em seringa/saco</span></div>
