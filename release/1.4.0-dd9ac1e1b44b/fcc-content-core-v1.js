(()=>{
  ...
  function styles(){
    ...
    const s=document.createElement('style');s.id='fcc-content-core-v1-style';s.textContent=`
      .fcc-modular-zone{display:grid;gap:10px;margin-top:12px}.fcc-modular-head{display:flex;align-items:flex-end;justify-content:space-between;gap:10px}.fcc-modular-head h3{margin:0;font-size:15px}.fcc-modular-head p{margin:3px 0 0;color:var(--muted);font-size:var(--fcc-caption,.8125rem)}.fcc-modular-tools{display:flex;gap:7px;align-items:center;flex-wrap:wrap}.fcc-modular-tools input,.fcc-modular-tools select{min-width:170px}
      .fcc-modular-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.fcc-modular-card{border:1px solid var(--line);border-radius:15px;background:var(--panel);overflow:hidden}.fcc-modular-card>summary{list-style:none;cursor:pointer;padding:12px;display:flex;gap:10px;align-items:center;justify-content:space-between}.fcc-modular-card>summary::-webkit-details-marker{display:none}.fcc-modular-card[open]{border-color:var(--line-strong)}.fcc-modular-title{min-width:0}.fcc-modular-title strong{display:block;font-size:13px;line-height:1.3}.fcc-modular-title span{display:block;margin-top:3px;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.4}.fcc-modular-chevron{color:var(--muted);transition:.15s}.fcc-modular-card[open] .fcc-modular-chevron{transform:rotate(180deg)}
      .fcc-modular-body{display:grid;gap:9px;padding:0 12px 12px;border-top:1px solid var(--line)}.fcc-modular-tags{display:flex;gap:5px;flex-wrap:wrap;padding-top:10px}.fcc-modular-tags span{font-size:var(--fcc-caption,.8125rem);border:1px solid var(--line);border-radius:999px;padding:4px 6px;color:var(--muted);background:var(--panel-2)}.fcc-modular-section{border:1px solid var(--line);border-radius:11px;padding:9px;background:var(--panel-2)}.fcc-modular-section h4{margin:0 0 5px;font-size:var(--fcc-caption,.8125rem);text-transform:uppercase;letter-spacing:.06em;color:var(--muted)}.fcc-modular-section p{margin:0;font-size:var(--fcc-caption,.8125rem);line-height:1.55}.fcc-modular-actions{display:flex;gap:6px;flex-wrap:wrap}.fcc-modular-empty{padding:12px;border:1px dashed var(--line);border-radius:12px;color:var(--muted);font-size:var(--fcc-caption,.8125rem)}
  ...
  function renderAction(a){
    ...
    let href='';if(a.href){try{const url=new URL(a.href,location.href);if(/^https?:$/.test(url.protocol))href=url.href;}catch{}}
    if(a.href&&!href)return `<span class="${cls}" aria-disabled="true">${esc(a.label)} (ligação inválida)</span>`;
    if(href)return `<a class="${cls}" href="${esc(href)}"${a.external!==false?' target="_blank" rel="noopener"':''}>${esc(a.label)}</a>`;
