...
(()=>{
 ...
 const definitions={
  shell:{scripts:['theme-switcher.js','theme-auto-v2.js','theme-audit-fixes.js','personal-security-v1.js','fcc-navigation.js','personal-hub-v1.js','fcc-backup.js','search-enhancer.js','fcc-favorites.js','fcc-offline.js'],ready:()=>!!window.FCCNavigation&&!!window.FCCAccess&&!!window.FCCBackup},
 ...
 function forRoute(page,sub=''){
  if(page==='home')return 'home';if(page==='settings')return 'shell';
