(()=>{
  ...
  function addStyles(){
    ...
    const s=document.createElement('style');s.id='cc-dil-v2-style';s.textContent=`
      .ccd-meta{display:flex;gap:7px;flex-wrap:wrap;margin:0 0 9px}.ccd-filter{min-width:230px}.ccd-ashp{border:1px solid rgba(114,227,167,.25);background:rgba(114,227,167,.06);border-radius:11px;padding:8px 9px;margin-top:8px}.ccd-ashp span,.ccd-prod span{display:block;font-size:var(--fcc-caption,.8125rem);letter-spacing:.08em;text-transform:uppercase;color:var(--muted);font-weight:900}.ccd-ashp b{display:block;margin-top:3px;font-size:var(--fcc-caption,.8125rem);color:var(--good)}.ccd-prod{margin-top:8px;border:1px solid var(--line);border-radius:11px;padding:8px 9px;background:var(--panel-2)}.ccd-prod strong{display:block;font-size:var(--fcc-caption,.8125rem);margin-top:3px}.ccd-prod p{margin:5px 0 0!important}.ccd-unverified{border-color:rgba(242,185,94,.25)!important}.ccd-source-row{display:flex;gap:6px;flex-wrap:wrap;margin-top:8px}.ccd-source-row a{font-size:var(--fcc-caption,.8125rem)}.ccd-group{font-size:var(--fcc-caption,.8125rem);color:var(--muted);margin-top:2px}.ccd-local{margin-top:7px;border:1px solid rgba(98,212,255,.2);border-radius:10px;padding:7px 8px}.ccd-local span{font-size:var(--fcc-caption,.8125rem);color:var(--muted);display:block}.ccd-local b{font-size:var(--fcc-caption,.8125rem)}.ccd-banner{font-size:var(--fcc-caption,.8125rem);line-height:1.55;margin:0 0 9px}
