(()=>{
  ...
  C.registerArea({id:'clinical-sepsis-extra',page:'clinical',target:'#clin-sepsis',targetId:'clin-sepsis',title:'Conteúdo adicional',description:'Cartões extensíveis de Sépsis / Choque.',searchLabel:'Clinical · Sépsis / Choque',searchable:true,filterable:true,items:[]});
