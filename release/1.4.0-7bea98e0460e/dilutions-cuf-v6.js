(()=>{
  ...
  function routeBlock(r){
    return `<section class="ccd-doc-route cuf2213-route">
      ...
      <div class="ccd-doc-grid"><h5 class="ccd-doc-section">Reconstituição</h5>${field('Especificações',r.reconstitution)}${field('Estabilidade',r.reconstitution_stability)}<div></div></div>
      <div class="ccd-doc-grid"><h5 class="ccd-doc-section">Diluição</h5>${field('Especificações',r.dilution)}${field('Estabilidade',r.dilution_stability)}<div></div></div>
