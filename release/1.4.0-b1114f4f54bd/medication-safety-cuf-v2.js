(()=>{
  ...
  function addStyles(){
    ...
    const s=document.createElement('style');s.id='cuf-med-safety-v2-style';s.textContent=`
      .cuf-safe-shell{display:grid;gap:12px}.cuf-safe-hero{display:flex;justify-content:space-between;gap:12px;align-items:flex-end;border:1px solid var(--line);border-radius:18px;background:linear-gradient(145deg,var(--panel),var(--panel-2));padding:14px}.cuf-safe-hero h2{margin:2px 0 4px;font-size:24px}.cuf-safe-hero p{margin:0;color:var(--muted);font-size:var(--fcc-caption,.8125rem)}.cuf-safe-meta{display:flex;gap:6px;flex-wrap:wrap}.cuf-safe-grid{display:grid;gap:12px}.cuf-safe-head{display:flex;justify-content:space-between;gap:10px;align-items:flex-start}.cuf-safe-head h3{margin:2px 0 4px}.cuf-safe-head p{margin:0;color:var(--muted);font-size:var(--fcc-caption,.8125rem)}.cuf-lasa-card>p{font-size:var(--fcc-caption,.8125rem);line-height:1.55;color:var(--text)}.cuf-lasa-callout{border:1px solid rgba(242,185,94,.28);background:var(--amber-soft);border-radius:12px;padding:10px;margin-top:9px}.cuf-lasa-callout b{display:block;color:var(--amber);font-size:var(--fcc-caption,.8125rem)}.cuf-lasa-callout span{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.45;margin-top:3px}.cuf-source-gap{margin-top:8px;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.5}.cuf-symbol-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:10px}.cuf-symbol-card{display:grid;grid-template-columns:110px minmax(0,1fr);align-items:center;gap:10px;border:1px solid var(--line);border-radius:13px;background:var(--panel-2);padding:9px}.cuf-symbol-card h4{margin:0 0 3px;font-size:var(--fcc-caption,.8125rem)}.cuf-symbol-card p{margin:0;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.45}.cuf-symbol-art{display:grid;place-items:center;min-height:64px}.cuf-sym-oct{width:74px;height:68px;background:#e11616;clip-path:polygon(30% 0,70% 0,100% 30%,100% 70%,70% 100%,30% 100%,0 70%,0 30%);display:grid;place-items:center;position:relative}.cuf-sym-oct:before{content:'';position:absolute;inset:6px;border:2px solid white;clip-path:inherit}.cuf-sym-oct span{position:relative;z-index:1;color:white;font-size:var(--fcc-caption,.8125rem);font-weight:1000;text-align:center;line-height:1.15}.cuf-sym-traffic{width:35px;height:72px;border-radius:17px;background:#1a2025;border:2px solid #4b555c;display:grid;place-items:center;padding:5px 0;box-sizing:border-box}.cuf-sym-traffic i{display:block;width:15px;height:15px;border-radius:50%;box-shadow:0 0 0 2px rgba(255,255,255,.16)}.cuf-sym-traffic i:nth-child(1){background:#ef4a52}.cuf-sym-traffic i:nth-child(2){background:#f4dc45}.cuf-sym-traffic i:nth-child(3){background:#48c873}.cuf-sym-yellow{width:98px;min-height:38px;box-sizing:border-box;border:2px solid #111;background:#ffe900;color:#111;display:grid;place-items:center;text-align:center;padding:5px;font-size:var(--fcc-caption,.8125rem);font-weight:1000;line-height:1.1}.cuf-sym-yellow small{font-size:var(--fcc-caption,.8125rem);font-weight:1000}.cuf-sym-two{gap:3px}.cuf-sym-acid{width:96px;height:28px;background:#ef1010;border:1px solid #7d0000}.cuf-sym-tall{border:1px solid var(--line-strong);border-radius:9px;background:var(--panel);padding:10px 8px;font-size:var(--fcc-caption,.8125rem);letter-spacing:.02em}.cuf-sym-tall b{font-size:13px;color:var(--clinical)}.cuf-rule-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;margin-top:9px}.cuf-rule-grid>div{border:1px solid var(--line);border-radius:11px;background:var(--panel-2);padding:9px}.cuf-rule-grid b{display:block;font-size:var(--fcc-caption,.8125rem)}.cuf-rule-grid span{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);line-height:1.45;margin-top:3px}.cuf-nine-title{margin:12px 0 7px;font-size:var(--fcc-caption,.8125rem)}.cuf-nine{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.cuf-nine span{display:flex;align-items:center;gap:7px;border:1px solid var(--line);border-radius:10px;padding:7px;font-size:var(--fcc-caption,.8125rem)}.cuf-nine b{display:grid;place-items:center;min-width:22px;height:22px;border-radius:7px;background:var(--clinical-soft);color:var(--clinical)}.cuf-imp-tools{display:grid;grid-template-columns:minmax(0,1fr) 260px;gap:7px;margin:9px 0}.cuf-imp-list{display:grid;gap:5px}.cuf-imp-row{display:grid;grid-template-columns:38px minmax(0,1fr) 90px;gap:8px;align-items:center;border:1px solid var(--line);border-radius:11px;background:var(--panel-2);padding:7px 8px}.cuf-imp-mini-oct{width:30px;height:28px;background:#e11616;clip-path:polygon(30% 0,70% 0,100% 30%,100% 70%,70% 100%,30% 100%,0 70%,0 30%);display:grid;place-items:center;color:#fff;font-size:var(--fcc-caption,.8125rem);font-weight:1000;text-align:center;line-height:1}.cuf-imp-main b{display:block;font-size:var(--fcc-caption,.8125rem)}.cuf-imp-main span{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);margin-top:2px}.cuf-imp-code{font-size:var(--fcc-caption,.8125rem);text-align:right}.cuf-imp-code b{display:block;color:var(--clinical);font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.cuf-safe-foot,.cuf-source-card p{font-size:var(--fcc-caption,.8125rem);color:var(--muted);line-height:1.5}.cuf-safe-foot{margin-top:8px}.cuf-doc-discrepancy{border-top:1px solid var(--line);padding-top:7px}.cuf-highalert-panel{margin-top:10px;border:1px solid rgba(235,74,82,.34);border-radius:12px;background:rgba(235,74,82,.055);padding:9px}.cuf-highalert-panel>summary{cursor:pointer;display:flex;align-items:center;gap:7px;font-size:var(--fcc-caption,.8125rem);font-weight:900;color:#ff7c82}.cuf-highalert-panel>summary span:last-child{margin-left:auto;color:var(--muted);font-size:var(--fcc-caption,.8125rem)}.cuf-highalert-note{font-size:var(--fcc-caption,.8125rem);color:var(--muted);line-height:1.45;margin:7px 0}.cuf-highalert-row{display:grid;grid-template-columns:minmax(0,1fr) 90px;gap:7px;border-top:1px solid var(--line);padding:7px 0;font-size:var(--fcc-caption,.8125rem)}.cuf-highalert-row small{display:block;color:var(--muted);font-size:var(--fcc-caption,.8125rem);margin-top:2px}.cuf-ha-electro{display:inline-block;margin-left:5px;border:1px solid #6b5e00;background:#ffe900;color:#111;border-radius:5px;padding:2px 4px;font-size:var(--fcc-caption,.8125rem);font-weight:1000}.cuf-ha-code{text-align:right;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;color:var(--clinical)}
