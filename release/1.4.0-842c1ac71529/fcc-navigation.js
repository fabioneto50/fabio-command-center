...
(()=>{
 ...
 async function navigate(page,opts={}){
  ...
  try{
   ...
   if(!U.active()){window.scrollTo({top:restore,behavior:'auto'});if(opts.focus){const heading=target.querySelector(opts.sub?'.fcc-area-current':'.pagehead h2');if(heading){heading.tabIndex=-1;heading.focus({preventScroll:true});}}}
