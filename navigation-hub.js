(()=>{
  ...
  load('./navigation-core.js?v=1.0.11')
    .then(()=>load('./perfusion-reference.js?v=1.0.11'))
    .then(()=>load('./family-security.js?v=1.0.11'))
    .then(()=>load('./clinical-material.js?v=1.0.11'))
    .then(()=>load('./iv-compatibility.js?v=1.0.11'))
    .then(()=>load('./iv-catalogue.js?v=1.0.11'))
    .then(()=>load('./iv-compatibility-ui-v2.js?v=1.0.11'))
    .then(()=>load('./iv-source-evidence.js?v=1.0.11'))
    .then(()=>{
