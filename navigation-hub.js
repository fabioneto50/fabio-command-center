(()=>{
  ...
  const critical=['runtime-diagnostics-v1.js','theme-switcher.js','theme-auto-v2.js','runtime-core-v1.js','personal-security-v1.js','search-enhancer.js','navigation-core.js','personal-hub-v1.js','subtab-navigation-fix.js'];
  const modules=[
    ...
    'theme-audit-fixes.js','global-typography-v1.js','home-current-news-v1.js','version-sync-v1.js','version-system-health-v1.js','resource-cleanup-v1.js'
  ];
  (async()=>{
