(()=>{
  ...
  load('./navigation-core.js?v=1.0.8')
    .then(()=>load('./perfusion-reference.js?v=1.0.8'))
    .then(()=>load('./family-security.js?v=1.0.8'))
    .then(()=>load('./clinical-material.js?v=1.0.8'))
    .then(()=>load('./iv-compatibility.js?v=1.0.8'))
    .then(()=>{
