const CACHE='fcc-master-1.3.2-wound-gallery-4';
const CORE=[
 ...
 './wound-dressings-local-data-v1.js','./wound-dressings-order-v1.js','./wound-dressings-images-v2.js','./wound-images-curated-v1.json',
 './wound-gallery-extras-v1.js','./wound-gallery-extra-01.json','./wound-gallery-extra-02.json','./wound-gallery-sheet-01.b64','./wound-gallery-sheet-02.b64'
];
...
self.addEventListener('fetch',event=>{
 ...
 if(event.request.mode==='navigate'||/\.(?:html|js|css|json|b64|webmanifest)$/.test(u.pathname))event.respondWith(networkFirst());
});
