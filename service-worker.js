const CACHE='fcc-master-1.0.26';
const CORE=['./','./index.html','./styles.css','./app.js','./navigation-hub.js','./theme-switcher.js','./navigation-core.js','./perfusion-reference.js','./critical-care-dilutions-v2.js','./family-security.js','./clinical-material.js','./iv-compatibility.js','./iv-catalogue.js','./iv-compatibility-ui-v2.js','./iv-source-evidence.js','./clinical-restructure.js','./drug-reference-v2.js','./medication-info-v3.js','./medication-info-v4.js','./medication-info-ux-v5.js','./ecg-photo-assist.js','./ecg-image-analyzer-v2.js','./ecg-image-analyzer-v3.js','./clinical-legacy-shims.js','./category-organizer.js','./expense-recurring-engine.js','./expense-center.js','./expense-recurring-ui.js','./theme-audit-fixes.js','./search-enhancer.js','./subtab-navigation-fix.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./content-pack.json','./build-info.json'];
