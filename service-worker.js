const CACHE='fcc-master-1.0.11';
const CORE=['./','./index.html','./styles.css','./app.js','./navigation-hub.js','./navigation-core.js','./perfusion-reference.js','./family-security.js','./clinical-material.js','./iv-compatibility.js','./iv-catalogue.js','./iv-compatibility-ui-v2.js','./iv-source-evidence.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./content-pack.json','./build-info.json'];
