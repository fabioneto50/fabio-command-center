const CACHE='fcc-master-1.0.14';
const CORE=['./','./index.html','./styles.css','./app.js','./navigation-hub.js','./theme-switcher.js','./navigation-core.js','./perfusion-reference.js','./family-security.js','./clinical-material.js','./iv-compatibility.js','./iv-catalogue.js','./iv-compatibility-ui-v2.js','./iv-source-evidence.js','./category-organizer.js','./expense-center.js','./theme-audit-fixes.js','./search-enhancer.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./content-pack.json','./build-info.json'];
