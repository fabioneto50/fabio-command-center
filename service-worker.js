const CACHE='fcc-master-1.3.2-modular-content-media-2';
const CORE=[
 ...
 './wound-dressings-local-data-v1.js','./wound-dressings-order-v1.js','./wound-dressings-images-v2.js','./wound-dressings-media-model-v1.js','./wound-images-user-v4.json'
];
